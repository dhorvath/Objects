...
document.getElementById("q1").innerHTML = "<p>"+"Name: " + me.name + " City: " + me.city + " Job: " + me.job+"</p>";
...
me.family = ["Justin", "Rachel", "Kyle"]
document.getElementById("q2").innerHTML = "<p>"+"Name: " + me.name + " City: " + me.city + " Job: " + me.job+ " Family: " + me.family+"</p>";
...
document.getElementById("q3a").innerHTML = "<p>"+"City_dot: " + me.city +"</p>";
document.getElementById("q3b").innerHTML = "<p>"+"City_bracket: " + me["city"] +"</p>";
...
document.getElementById("q4").innerHTML = "<p>"+"Penny's dinner: " + invitees.adults[0].dinnerChoice +"</p>";
...
document.getElementById("q6").innerHTML = "<p>"+"Lauren's table number: " + invitees.adults[2].specialConsiderations.seating +"</p>";

// 7. Access Billy's dessert choice (this will be the third item in his dinnerChoice array)

document.getElementById("q7").innerHTML = "<p>"+"Billy's desert choice: " + invitees.adults[1].dinnerChoice[2] +"</p>";

// 8. Access Ada's allergies.

document.getElementById("q8").innerHTML = "<p>"+"Billy's desert choice: " + invitees.children[2].allergies +"</p>";

// 9. Create a string that reads Lauren's dinner choice in a sentence.
// Desired result: "Lauren's appetizer is _______. She will be eating ______ for dinner
// and has selected ________ as her dessert."

document.getElementById("q9").innerHTML = "<p>"+"Lauren's appetizer is " + invitees.adults[2].dinnerChoice[0] + "." + "She will be eating " + invitees.adults[2].dinnerChoice[1] + " for dinner and has selected " + invitees.adults[2].dinnerChoice[2] + " for desert." + "</p>";
...
//classmates
jsWorkshop.classmates = ["Harry", "Larry", "Moe", "Curly"]
